...
public class BottomSheetAcitvity extends AppCompatActivity implements View.OnClickListener {
...
/*
    ...
    public void onClick(View view) {
        Intent sendLocationIntent = new Intent(getApplicationContext(), HomeAcitvity.class);
